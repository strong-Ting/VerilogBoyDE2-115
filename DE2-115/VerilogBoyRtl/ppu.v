...
module ppu(
    ...
    wire window_trigger = (((h_pix_output) == (reg_wx))&&(v_pix >= reg_wy)&&(reg_win_en)&&(~window_triggered)) ? 1'd1 : 1'd0;
    ...
    wire obj_trigger = ((reg_obj_en)&&(obj_trigger_id_next != OBJ_TRIGGER_NOT_FOUND)) ? 1'd1 : 1'd0;
    //wire obj_trigger = 0;
    ...
    always @(posedge clk)
        if (rst)
            ...
            reg_stat[2] <= (reg_ly == reg_lyc) ? 1'd1 : 1'd0;
